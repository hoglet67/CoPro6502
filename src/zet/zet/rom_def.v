...
`define POPA	10'b0111100110
`define INVOP	10'b0111110101
`define INSB	10'b1000000010
`define INSW	10'b1000000101
`define INSBR	10'b1000001000
`define INSWR	10'b1000001100
`define OUTSB	10'b1000010000
`define OUTSW	10'b1000010011
`define OUTSBR	10'b1000010110
`define OUTSWR	10'b1000011010
